...
void Init_Port3(void); //char smclk initially passed
...
void triangle_straight(void);
void left_case(void);
void Movement_Off(void);
void RightForwardOn(void);
void LeftForwardOn(void);
void RightReverseOn(void);
void LeftReverseOn(void);
void Wheel_Check(void);
void Run_LeftFix(void);
void Run_RightFix(void);
